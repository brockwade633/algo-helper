...
const StepControlPanel = (props): JSX.Element => {
  ...
  return (
    <Box pad={{ top: "none", bottom: "small" }} flex={false} align="center" direction="column">
      <Box direction="row">
        <Text size="xsmall" weight="bold" margin={{ left: "small", right: "small", top: "none", bottom: "xsmall" }}>F9</Text>
        <Text size="xsmall" weight="bold" margin={{ left: "small", right: "small", top: "none", bottom: "xsmall" }}>F4</Text>
        <Text size="xsmall" weight="bold" margin={{ left: "small", right: "small", top: "none", bottom: "xsmall" }}>F5</Text>
        <Text size="xsmall" weight="bold" margin={{ left: "small", right: "small", top: "none", bottom: "xsmall" }}>F10</Text>
      </Box>
      <Box
        background="silver"
        round="small"
        ...
        direction="row"
      >
        <Button icon={<Previous size="16px" color="black" />} hoverIndicator={true} onClick={previous} />
        <Button icon={<Refresh size="16px" color="black" />} hoverIndicator={true} onClick={reset} />
        ...
        <Button icon={(isPlaying) ? (<PauseFill size="16px" color="black" />) : (<PlayFill size="16px" color="black" />)} hoverIndicator={true} onClick={isPlaying ? pause : play} />
        <Button icon={<Next size="16px" color="black" />} hoverIndicator={true} onClick={next} />
      </Box>
    </Box>
  );
};
